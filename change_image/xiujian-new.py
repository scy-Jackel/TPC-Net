...
flag=-1
num=0
tiff=tifffile.imread("data_3D_final/3-54.tif")
for i in range(50):
    for j in range(50):
        for k in range(50):
...
tiff2=tifffile.imread("data6/3-54.tif")
...
while(biao<15):
    ...
    xxx=res_new[biao][1]
    yyy=res_new[biao][2]
    if(tiff2[zzz][xxx][yyy][0]<yuzhi):
        flag1+=1
    if (tiff2[zzz+1][xxx][yyy][0] < yuzhi):
        flag1 += 1
    if (tiff2[zzz-1][xxx][yyy][0] < yuzhi):
        flag1 += 1
    if (tiff2[zzz][xxx+1][yyy][0] < yuzhi):
        flag1 += 1
    if (tiff2[zzz][xxx-1][yyy][0] < yuzhi):
        flag1 += 1
    if (tiff2[zzz][xxx][yyy+1][0] < yuzhi):
        flag1 += 1
    if (tiff2[zzz][xxx][yyy-1][0] < yuzhi):
        flag1 += 1
    if(flag1>=1):
...
tifffile.imsave("data_xiujian_new/3-54-xj.tif",tiff)
tiff1=tiff
