...
trainloader = torch.utils.data.DataLoader(train_data,batch_size = 16,shuffle = True,drop_last=True)
testloader = torch.utils.data.DataLoader(test_data,batch_size = 16,drop_last=True)
validloader = torch.utils.data.DataLoader(valid_data,batch_size = 16,drop_last=True)
...
deep_learning(myAlexNet,trainloader,25,120,loss_func,optimizer,'cuda:1')
...
np.save("X_3_16_2",X_3_32_2)
np.save("train_loss_3_16_2",train_loss_3_32_2)
np.save("valid_loss_3_16_2",valid_loss_3_32_2)
np.save("valid_accc_3_16_2",valid_accc_3_32_2)

print("测试集：")
accuracy_test(myAlexNet, testloader, loss_func)

path_state_dict = "./model_state_dict_3_16_2.pkl"
