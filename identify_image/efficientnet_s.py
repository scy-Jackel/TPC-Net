...
np.save("X_32_effi_ss",X_3_32_2)
np.save("train_loss_effi_ss",train_loss_3_32_2)
np.save("valid_loss_effi_ss",valid_loss_3_32_2)
np.save("valid_accc_effi_ss",valid_accc_3_32_2)

path_state_dict = "./model_state_dict_effi_ss.pkl"
