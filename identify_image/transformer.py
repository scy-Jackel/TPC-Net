...
#
# np.save("X_32_trans",X_3_32_2)
# np.save("train_loss_trans",train_loss_3_32_2)
# np.save("valid_loss_trans",valid_loss_3_32_2)
# np.save("valid_accc_trans",valid_accc_3_32_2)
#
# path_state_dict = "./model_state_dict_trans.pkl"
