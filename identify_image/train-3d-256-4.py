...
deep_learning(myAlexNet,trainloader,20,240,loss_func,optimizer)
...
np.save("X_32_AlexNet_xiugai_42",X_3_32_2)
np.save("train_loss_32_AlexNet_xiugai_42",train_loss_3_32_2)
np.save("valid_loss_32_AlexNet_xiugai_42",valid_loss_3_32_2)
np.save("valid_accc_32_AlexNet_xiugai_42",valid_accc_3_32_2)

path_state_dict = "./model_state_dict_32_AlexNet_xiugai_42.pkl"
