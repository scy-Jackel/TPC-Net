...
np.save("X_3_32_3",X_3_32_2)
np.save("train_loss_3_32_3",train_loss_3_32_2)
np.save("valid_loss_3_32_3",valid_loss_3_32_2)
np.save("valid_accc_3_32_3",valid_accc_3_32_2)

print("测试集：")
accuracy_test(myAlexNet, testloader, loss_func)

path_state_dict = "./model_state_dict_3_32_3.pkl"
